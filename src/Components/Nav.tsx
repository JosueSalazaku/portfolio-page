    ...
    <nav className='mx-auto h-[50px] flex flex-col justify-center items-center rounded border-white fixed bottom-20 left-0 right-0 z-50'>
      <div className='w-[250px] h-[50px] flex flex-row items-center px-10 justify-between rounded-md 
        ...
        <ul className='flex flex-row items-center justify-between w-full'>
          <Link href="/">
            <li className="text-lg px-2 font-semibold text-black rounded-md dark:font-light dark:text-gray-200 hover:bg-blue-600">H</li> 
          </Link>
          <Link href="/works">
            <li className="text-lg px-2 font-semibold text-black rounded-md dark:font-light dark:text-gray-200 hover:bg-red-600">W</li>
          </Link>
          <ModeToggle />
        </ul>
      </div>
